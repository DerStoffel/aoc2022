// elves in groups of three
// elf has badge of group
// badge == itemtype carried by all 3 elves
// find item type common in each group
// every three lines are one group
// 
...
CrZsJsPPZsGzwwsLwLmpwMDw`;
    ...
    test('has priority', () => {
        expect(calculatePriority(input)).toBe(70);
    })
});